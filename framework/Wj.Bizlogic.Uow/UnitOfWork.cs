...
namespace Wj.Bizlogic.Uow
{
    public class UnitOfWork : IUnitOfWork, ITransientDependency
    {
        ...
        public const string UnitOfWorkReservationName = "_AppActionUnitOfWork";

        public Guid Id { get; } = Guid.NewGuid();

        public IAppUnitOfWorkOptions Options { get; private set; } = default!;
        ...
        private readonly AppUnitOfWorkDefaultOptions _defaultOptions;
        ...
        public UnitOfWork(
            ...
            IOptions<AppUnitOfWorkDefaultOptions> options)
        {
        ...
        public virtual void Initialize(AppUnitOfWorkOptions options)
        {
            Check.NotNull(options, nameof(options));

            if (Options != null)
            {
                throw new AppException("This unit of work has already been initialized.");
            }
        ...
        public virtual void AddDatabaseApi(string key, IDatabaseApi api)
        {
            ...
            {
                throw new AppException("This unit of work already contains a database API for the given key.");
            }
        ...
        public virtual void AddTransactionApi(string key, ITransactionApi api)
        {
            ...
            {
                throw new AppException("This unit of work already contains a transaction API for the given key.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new AppException("Completion has already been requested for this unit of work.");
            }
        }
