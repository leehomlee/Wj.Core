...
namespace Autofac.Builder
{
    ...
    {
        public static IRegistrationBuilder<TLimit, TActivatorData, TRegistrationStyle> ConfigureAppConventions<TLimit, TActivatorData, TRegistrationStyle>(
        ...
        private static IRegistrationBuilder<TLimit, TActivatorData, TRegistrationStyle> EnablePropertyInjection<TLimit, TActivatorData, TRegistrationStyle>(
            ...
            where TActivatorData : ReflectionActivatorData
        {
            // Enable Property Injection only for types in an assembly containing an AppModule and without a DisablePropertyInjection attribute on class or properties.
            ...
            where TActivatorData : ReflectionActivatorData
        {
            ...
            foreach (var interceptor in interceptors)
            {
                registrationBuilder.InterceptedBy(
                    typeof(AppAsyncDeterminationInterceptor<>).MakeGenericType(interceptor)
                );
            }
