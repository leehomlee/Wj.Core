...
namespace Wj.Bizlogic.SimpleStateChecking
{
    ...
    where TState : IHasSimpleStateCheckers<TState>
    {
        ...
        protected AppSimpleStateCheckerOptions<TState> Options { get; }

        public SimpleStateCheckerManager(IServiceProvider serviceProvider, IOptions<AppSimpleStateCheckerOptions<TState>> options)
        {
