...
namespace Microsoft.Extensions.Configuration
{
    ...
    {
        public static IConfigurationRoot BuildConfiguration(AppConfigurationBuilderOptions? options = null, Action<IConfigurationBuilder>? builderAction = null)
        {
            options ??= new AppConfigurationBuilderOptions();
