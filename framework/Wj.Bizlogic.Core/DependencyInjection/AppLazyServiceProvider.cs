...
namespace Wj.Bizlogic.DependencyInjection
{
    ...
    /// </summary>
    [ExposeServices(typeof(IAppLazyServiceProvider))]
    public class AppLazyServiceProvider : CachedServiceProviderBase, IAppLazyServiceProvider, ITransientDependency
    {
        public AppLazyServiceProvider(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        }
