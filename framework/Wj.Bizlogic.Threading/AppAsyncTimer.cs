...
namespace Wj.Bizlogic.Threading
{
    ...
    /// </summary>
    public class AppAsyncTimer : ITransientDependency
    {
        /// <summary>
        /// This func is raised periodically according to Period of Timer.
        /// </summary>
        public Func<AppAsyncTimer, Task> Elapsed = _ => Task.CompletedTask;
        ...
        public ILogger<AppAsyncTimer> Logger { get; set; }
        ...
        public AppAsyncTimer()
        {
            ExceptionNotifier = NullExceptionNotifier.Instance;
            Logger = NullLogger<AppAsyncTimer>.Instance;
        ...
        public void Start(CancellationToken cancellationToken = default)
        {
            if (Period <= 0)
            {
                throw new AppException("Period should be set before starting the timer!");
            }
