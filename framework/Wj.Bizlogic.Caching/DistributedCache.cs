...
namespace Wj.Bizlogic.Caching
{
        ...
        where TCacheKey : notnull
    {
        ...
        private readonly AppDistributedCacheOptions _distributedCacheOption;

        public DistributedCache(
            IOptions<AppDistributedCacheOptions> distributedCacheOption,
        ...
        protected virtual KeyValuePair<TCacheKey, TCacheItem?>[] ToCacheItems(byte[]?[] itemBytes, TCacheKey[] itemKeys)
        {
            ...
            {
                throw new AppException("count of the item bytes should be same with the count of the given keys");
            }
        ...
        protected virtual Dictionary<TCacheKey, UnitOfWorkCacheItem<TCacheItem>> GetUnitOfWorkCache()
        {
            ...
            {
                throw new AppException($"There is no active UOW.");
            }
